...
\subsection{Origen y alcance de la termodinámica}
    ...
    Entonces un sistema de unidades toma una serie de dimensiones básicas a partir de las cuales se eligen arbitrariamente unidades básicas para realizar mediciones sobre las dimensiones básicas. Generalmente en física se suelen elegir como dimensiones básicas la longitud \textbf{L}\nomenclature{\textbf{L}}{Dimensión longitud}, el tiempo \textbf{T} \nomenclature{\textbf{T}}{Dimensión tiempo}, la masa \textbf{M}\nomenclature{\textbf{M}}{Dimensión masa}, la temperatura \( \bm{\Theta} \)\nomenclature{\( \bm{\Theta} \) }{Dimensión temperatura}.
